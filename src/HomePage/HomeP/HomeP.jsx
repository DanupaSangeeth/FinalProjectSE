...
const HomePage = () => {
  ...
  return (
    <div className='land'>
      ...
      <img src={lan} width={"1000px"} height={"1000px"} className=' justify-center align-middle mt-48 ml-52 box-border'/>
      <div className=' align-middle justify-center max-w-7xl text-center ml-44 mt-28' id='about'>
      <h3 id='us' className=' text-2xl font-black drop-shadow-4xl shadow-black'  data-aos="zoom-in-down">About Us</h3>
      <br></br>
      <br></br>
              <p id='about' className='drop-shadow-3xl shadow-black'  data-aos="zoom-in-down">
An online driving license system refers to a digital platform or system that allows individuals to apply for, renew, or manage their driving licenses over the internet. This system offers a convenient and efficient way for citizens to handle their driving license-related tasks without having to visit physical offices or departments..</p>
      ...
      <div className="md:w-2/5 ml-24 mt-48" id='depa'>
            ...
            <h2 className="para1  md:text-5x1 text-5xl font-bold text-primary mb-7 mt-10 leading-normal" data-aos="fade-down-right">Driving schools
             <span className=" text-secondary">(Island wide.)</span></h2>
            <p className=" subp  text-tartiary text-lg mb-1 " data-aos="fade-down-right">A driving school is a business that employs instructors who teach people how to drive a vehicles. To do that island wide driving schools can join to our system through this</p>
            ...
            <div className="md:w-5/5 ml-24 mt-48" id='cus'>
